...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [mean_initial_values, sigma_initial_values] = initial_format()
...
mean_initial_values = [voff_pd1_mean, vth0_pd1_mean, ub_pd1_mean, voff_wl1_mean, vth0_wl1_mean, ub_wl1_mean];
sigma_initial_values = [voff_pd1_sigma, vth0_pd1_sigma, ub_pd1_sigma, voff_wl1_sigma, vth0_wl1_sigma, ub_wl1_sigma];
